...
class SOLUTION: 
    ...
    def Create_Brain(self):
        ...
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+1 , jointName = "Torso_BackLowerLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+2 , jointName = "Lower_BackLowerLeg")

        pyrosim.Send_Sensor_Neuron(name = 3 , linkName = "FrontLeg")
        pyrosim.Send_Sensor_Neuron(name = 4 , linkName = "FrontLowerLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+3 , jointName = "Torso_FrontLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+4 , jointName = "Torso_FrontLowerLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+5 , jointName = "Lower_FrontLowerLeg")

        pyrosim.Send_Sensor_Neuron(name = 5 , linkName = "LeftLeg")
        pyrosim.Send_Sensor_Neuron(name = 6 , linkName = "LeftLowerLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+6 , jointName = "Torso_LeftLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+7 , jointName = "Torso_LeftLowerLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+8 , jointName = "Lower_LeftLowerLeg")

        pyrosim.Send_Sensor_Neuron(name = 7 , linkName = "RightLeg")
        pyrosim.Send_Sensor_Neuron(name = 8 , linkName = "RightLowerLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+9 , jointName = "Torso_RightLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+10 , jointName = "Torso_RightLowerLeg")
        ...
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+12 , jointName = "Torso_BackSideLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+13 , jointName = "Torso_BackSideLowerLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+14 , jointName = "Lower_BackSideLowerLeg")

        pyrosim.Send_Sensor_Neuron(name = 11 , linkName = "FrontSideLeg")
        pyrosim.Send_Sensor_Neuron(name = 12 , linkName = "FrontSideLowerLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+15 , jointName = "Torso_FrontSideLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+16 , jointName = "Torso_FrontSideLowerLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+17 , jointName = "Lower_FrontSideLowerLeg")

        pyrosim.Send_Sensor_Neuron(name = 13 , linkName = "LeftSideLeg")
        pyrosim.Send_Sensor_Neuron(name = 14 , linkName = "LeftSideLowerLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+18 , jointName = "Torso_LeftSideLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+19 , jointName = "Torso_LeftSideLowerLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+20 , jointName = "Lower_LeftSideLowerLeg")

        pyrosim.Send_Sensor_Neuron(name = 15 , linkName = "RightSideLeg")
        pyrosim.Send_Sensor_Neuron(name = 16 , linkName = "RightSideLowerLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+21 , jointName = "Torso_RightSideLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+22 , jointName = "Torso_RightSideLowerLeg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+23 , jointName = "Lower_RightSideLowerLeg")
