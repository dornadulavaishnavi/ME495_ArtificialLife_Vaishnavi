...
class SOLUTION: 
    ...
    def Create_Body(self):
        ...
        pyrosim.Send_Joint( name = "Torso_BackLowerLeg" , parent= "Torso" , child = "BackLowerLeg" , type = "revolute", position = [0.0,-1.0,0.0], jointAxis = "1 0 0")
        pyrosim.Send_Cube(name="BackLowerLeg", pos=[0.0,0.0,-0.5] , size=[0.2,0.2,1])
        pyrosim.Send_Joint( name = "Torso_FrontLowerLeg" , parent= "Torso" , child = "FrontLowerLeg" , type = "revolute", position = [0.0,1.0,0.0], jointAxis = "1 0 0")
        pyrosim.Send_Cube(name="FrontLowerLeg", pos=[0.0,0.0,-0.5] , size=[0.2,0.2,1])
        pyrosim.Send_Joint( name = "Torso_LeftLowerLeg" , parent= "Torso" , child = "LeftLowerLeg" , type = "revolute", position = [-1.0,0.0,0.0], jointAxis = "1 0 0")
        pyrosim.Send_Cube(name="LeftLowerLeg", pos=[0.0,0.0,-0.5] , size=[0.2,0.2,1])
        pyrosim.Send_Joint( name = "Torso_RightLowerLeg" , parent= "Torso" , child = "RightLowerLeg" , type = "revolute", position = [1.0,0.0,0.0], jointAxis = "1 0 0")
